...
One to match to existing Wikidata id, plus one to create:

* wb ce create-new-party.js "Republican Socialist Party"  | jq -r '.entity.id'
...
Then sent to QuickStatements as https://editgroups.toolforge.org/b/QSv2T/1598332058678/
